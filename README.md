...
`image_url` for each metal is generated from `FX_METAL_IMAGE_BASE_URL` when set; otherwise it falls back to `${FX_BASE_URL}/assets/metals/<symbol>.png` (e.g., `xau.png`).
