...
export default function PressPage() {
    const news = [
        { source: 'Financial Times', date: 'Oct 12, 2024', title: 'Fortress Vault Reports Record Inflows as Investors Seek Safe Havens', excerpt: 'Digital gold platform sees 200% growth in quarterly vault deposits...' },
        { source: 'TechCrunch', date: 'Aug 28, 2024', title: 'The Fintech Startups Revolutionizing Asset Ownership', excerpt: 'How Fortress Vault is using technology to make gold bars as liquid as cash...' },
        { source: 'Bloomberg', date: 'May 15, 2024', title: 'Interview: CEO of Fortress Vault on the Future of Digital Assets', excerpt: 'We are bridging the gap between physical security and digital speed...' },
    ];
